...
static const char qt_meta_stringdata_DeepSkyBrowser[] = {
    "DeepSkyBrowser\0\0pos,sel\0"
...
const QMetaObjectExtraData DeepSkyBrowser::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DeepSkyBrowser::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DeepSkyBrowser,
      qt_meta_data_DeepSkyBrowser, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DeepSkyBrowser::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DeepSkyBrowser))
