...
static const char qt_meta_stringdata_CelestiaGlWidget[] = {
    "CelestiaGlWidget\0"
};
...
const QMetaObjectExtraData CelestiaGlWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CelestiaGlWidget::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_CelestiaGlWidget,
      qt_meta_data_CelestiaGlWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CelestiaGlWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CelestiaGlWidget))
